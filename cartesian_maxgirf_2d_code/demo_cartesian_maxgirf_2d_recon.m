...
%     %sens = bsxfun(@times, sens, ev_mask_dilated);
    ...
    Ah = @(x) cartesian_maxgirf_2d_adjoint(x, sens, mask, p1, p2, iflag, eps, support_mask, U, V, L, initial_phase);
    AhA = @(x) cartesian_maxgirf_2d_normal(x, sens, mask, p1, p2, iflag, eps, support_mask, U, V, L, initial_phase, lambda);
